(function() {
  ...
  const Ae = 'import"x"assert{type:"css"}';
  const xe = 'import"x"assert{type:"json"}';
      ...
      return t
        ? new Promise(e => {
            ...
            const r = `<script nonce=${ne ||
              ...
              Le ? "true,true" : `'x',b('${Ce}')`
            }, ${pe ? `b('${Ae}'.replace('x',b('','text/css')))` : "false"}, ${
              be ? `b('${xe}'.replace('x',b('{}','text/json')))` : "false"
        ...
        : Promise.all([
            Le || ge(createBlob(Ce)).then(() => (Oe = true), noop),
            pe &&
              ge(createBlob(Ae.replace("x", createBlob("", "text/css")))).then(
                () => (Se = true),
                noop
              ),
            be &&
  ...
  const je =
    ...
    Re =
      "xportmportlassetafromssertvoyiedelecontininstantybreareturdebuggeawaithrwhileforifcatcfinallels";
  let Te, _e, Ne;
  function parse(e, t = "@") {
    (Te = e), (_e = t);
                      ...
                      case 41: {
                        ...
                        if (
                          (r << 16) >> 16 != 0
                            ? ((se =
                                a[
                                  ((a[64] | 0) + (((r & 65535) + -1) << 2)) >> 2
                                ] | 0),
                              (a[(se + 20) >> 2] | 0) ==
                                (a[
                                  ((a[63] | 0) + ((t & 65535) << 3) + 4) >> 2
                                ] |
                                  0))
                            : 0
                        ) {
    ...
    for (; Ue.ri(); ) {
      ...
      let c;
      Ue.ip() &&
        (c = b(-1 === s ? e : e + 1, Te.charCodeAt(-1 === s ? e - 1 : e))),
  ...
  function b(e, t) {
    ...
    for (;;) {
      ...
      if (e === t) break;
      92 === e
        ? ((r += Te.slice(s, Ne)), (r += l()), (s = Ne))
        : (8232 === e || 8233 === e || (u(e) && o()), ++Ne);
    }
    return (r += Te.slice(s, Ne++)), r;
  }
  function l() {
  ...
  function o() {
    throw Object.assign(
      Error(
        `Parse error ${_e}:${Te.slice(0, Ne).split("\n").length}:${Ne -
          Te.lastIndexOf("\n", Ne - 1)}`
      ),
      { idx: Ne }
    );
  ...
  async function importShim(e, ...r) {
    ...
    await Je;
    return topLevelLoad((await He(e, s)).r, { credentials: "same-origin" });
  }
  ...
  async function topLevelLoad(e, t, r, s, i) {
    ...
    if (!n && qe) {
      if (s) return null;
      await i;
      return ge(r ? createBlob(r) : e, { errUrl: e || r });
    }
    ...
    await i;
    if (r && !n && !c.n && true) {
      const e = await ge(createBlob(r), { errUrl: r });
    ...
    const te = await ge(n || c.n || !s ? c.b : c.u, { errUrl: c.u });
      ...
      for (const { s: oe, ss: ce, se: le, d: fe } of r)
        if (-1 === fe) {
          ...
          pe &&
            ((de = ue.s) ||
              (de = ue.s = createBlob(
                `export function u$_(m){${ue.a[1]
                  .map(({ s: e, e: t }, r) => {
                    const s = '"' === ue.S[e] || "'" === ue.S[e];
                    return `e$_${r}=m${s ? "[" : "."}${ue.S.slice(e, t)}${
                      s ? "]" : ""
                    }`;
                  })
                  .join(",")}}${
                  ue.a[1].length
                    ? `let ${ue.a[1].map((e, t) => `e$_${t}`).join(",")};`
                    : ""
                }export {${ue.a[1]
                  .map(({ s: e, e: t }, r) => `e$_${r} as ${ue.S.slice(e, t)}`)
  ...
  function pushFetchPool() {
    if (++et > 100) return new Promise(e => Ze.push(e));
  }
  ...
  async function fetchModule(e, t, r) {
    ...
    if (Ge.test(n)) return { r: s.url, s: await s.text(), t: "js" };
    if (Ve.test(n))
      ...
      if (ze) {
        Je = Je.then(async () => {
          ...
          t instanceof SyntaxError &&
            (t = new Error(
              `Unable to parse import map ${t.message} in: ${e.src ||
                e.innerHTML}`
            ));
          throwError(t);
        });
